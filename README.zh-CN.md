...
<p align="center">
  <a href="https://github.com/edison7009/OpenLongevity/releases/latest"><strong>下载最新版</strong></a> · <a href="https://openlongevity.life/">项目网站</a>
</p>

> 富豪可以组建医疗团队、持续追踪指标、整理研究并迭代个人方案。<br>
> 普通人同样应该拥有理解科学证据、管理个人知识和使用 AI 工具的权利。

Open Longevity 希望把散落在论文、公开人物方案和个人记录中的延寿知识，变成每个人都能阅读、核查、积累和使用的开放工具。它不兜售“永生捷径”，也不把昂贵方案简单复制给所有人；它提供的是一套透明、可追溯、可在本地掌控的科学延寿工作台。
...
- 内置 **88 份中文资料和 88 份英文配套资料**；
- 覆盖力量训练、有氧运动、健康饮食、肌酸、Omega-3、维生素、NAD+ 等策略；
- 收录 Bryan Johnson 等公开人物案例，以及地区和文化中的延寿观察；
