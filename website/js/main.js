(() => {
  ...
  const copy = {
    zh: {
      ...
      heroBody: "富豪花费百万美元借助科技延寿，而 Open Longevity 希望把生命之光同样带给普通家庭",
      ...
      product3Title: "AI 延寿助力", product3Body: "围绕你的资料持续对话。它记得当前上下文，也清楚地区分个人方案、一般信息与尚未证实的推测。",
    ...
    en: {
      ...
      heroDetail: "Built on Bryan Johnson's publicly documented longevity plan, enriched with AI and scientific evidence, so ordinary people can access longevity strategies once reserved for the wealthy.",
